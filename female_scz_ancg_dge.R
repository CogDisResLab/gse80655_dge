...
counts_file <- "data/AnCg_female-scz-counts.csv"
metadata_file <- "data/AnCg_female-scz-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_scz_ancg_dge.csv")

save(out_filtered, file = "results/female_scz_ancg_dge.RData")
