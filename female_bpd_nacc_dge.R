...
counts_file <- "data/nAcc_female-bpd-counts.csv"
metadata_file <- "data/nAcc_female-bpd-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_bpd_nacc_dge.csv")

save(out_filtered, file = "results/female_bpd_nacc_dge.RData")
