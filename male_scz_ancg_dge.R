...
counts_file <- "data/AnCg_male-scz-counts.csv"
metadata_file <- "data/AnCg_male-scz-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_scz_ancg_dge.csv")

save(out_filtered, file = "results/male_scz_ancg_dge.RData")
