...
counts_file <- "data/nAcc_female-counts.csv"
metadata_file <- "data/nAcc_female-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_nacc_dge.csv")

save(out_filtered, file = "results/female_nacc_dge.RData")
