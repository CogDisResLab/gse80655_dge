...
counts_file <- "data/DLPFC_female-scz-counts.csv"
metadata_file <- "data/DLPFC_female-scz-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_scz_dlpfc_dge.csv")

save(out_filtered, file = "results/female_scz_dlpfc_dge.RData")
