...
counts_file <- "data/DLPFC_male-scz-counts.csv"
metadata_file <- "data/DLPFC_male-scz-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_scz_dlpfc_dge.csv")

save(out_filtered, file = "results/male_scz_dlpfc_dge.RData")
