...
counts_file <- "data/nAcc_male-counts.csv"
metadata_file <- "data/nAcc_male-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_nAcc_dge.csv")

save(out_filtered, file = "results/male_nAcc_dge.RData")
