...
counts_file <- "data/nAcc_male-scz-counts.csv"
metadata_file <- "data/nAcc_male-scz-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_scz_nAcc_dge.csv")

save(out_filtered, file = "results/male_scz_nAcc_dge.RData")
