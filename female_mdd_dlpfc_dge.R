...
counts_file <- "data/DLPFC_female-counts.csv"
metadata_file <- "data/DLPFC_female-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_dlpfc_dge.csv")

save(out_filtered, file = "results/female_dlpfc_dge.RData")
