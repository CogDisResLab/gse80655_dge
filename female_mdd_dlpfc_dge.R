...
counts_file <- "data/DLPFC_female-mdd-counts.csv"
metadata_file <- "data/DLPFC_female-mdd-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/female_mdd_dlpfc_dge.csv")

save(out_filtered, file = "results/female_mdd_dlpfc_dge.RData")
