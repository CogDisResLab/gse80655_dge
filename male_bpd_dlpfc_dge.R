...
counts_file <- "data/DLPFC_male-bpd-counts.csv"
metadata_file <- "data/DLPFC_male-bpd-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_bpd_dlpfc_dge.csv")

save(out_filtered, file = "results/male_bpd_dlpfc_dge.RData")
