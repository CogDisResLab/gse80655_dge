...
counts_file <- "data/DLPFC_male-counts.csv"
metadata_file <- "data/DLPFC_male-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_dlpfc_dge.csv")

save(out_filtered, file = "results/male_dlpfc_dge.RData")
