...
counts_file <- "data/DLPFC_male-mdd-counts.csv"
metadata_file <- "data/DLPFC_male-mdd-metadata.csv"
...
out_filtered$complete_table %>%
  ...
  write_csv("results/male_mdd_dlpfc_dge.csv")

save(out_filtered, file = "results/male_mdd_dlpfc_dge.RData")
